...
\begin{frame}{Installation on Microsoft\textsuperscript{\textregistered}\ Windows\textsuperscript{\textregistered}}
  ...
  \begin{itemize}
    \item 进入Advanced设置
  \end{itemize}
  \includegraphics[width=0.8\linewidth]{pic/screenshot2.png}
\end{frame}
\begin{frame}{Installation on Microsoft\textsuperscript{\textregistered}\ Windows\textsuperscript{\textregistered}}
  接下来的操作请拍照保存,并主动寻求staff的协助
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Hint: Package names: \\
          \begin{tabular}{|l l|}
            ...
            Arch系\footnote{Arch系Distro以拆包少著称，但是texlive也拆了\includegraphics[width=0.03\linewidth]{pic/image.png}} & texlive-most        \\
            \hline
          \end{tabular}
  \end{itemize}
\end{frame}
\begin{frame}{Installation on GNU/Linux}
  ちょっと待って！
  \begin{itemize}
    \item 如果您是GNU/Linux用户，可能没有太多必要\dots \includegraphics[width=0.03\linewidth]{pic/image.png}
    \item 此外我们强烈建议您加入SHUOSC
  \end{itemize}
\end{frame}
