...
\cmd{chapter}{前言}{{\heiti 第 1 章\hspace{1em} 前言}} \\
\cmd{section[精简标题]}{这个题目实在太长了放到目录里面不太好看}{{\heiti 1.1
...
\begin{frame}[fragile]{交叉引用与插入插图}
    ...
    \end{lstlisting}
      ...
      \begin{minipage}{0.3\linewidth}\centering
        {\songti SHUOSC徽章请参见图~1。}\\[1em]
     \includegraphics[height=0.2\textheight]{pic/shuosc.png}\\
     {\footnotesize\heiti 图~1. SHUOSC徽章。}
      \end{minipage}
    \end{frame}
